drop table if exists APP_INTELCOMERCIAL_DM.DISTRIBUTOR_ACCOUNT_VF;

CREATE table IF NOT EXISTS APP_INTELCOMERCIAL_DM.DISTRIBUTOR_ACCOUNT_VF
AS
SELECT
